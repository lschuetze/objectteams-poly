...
public void test0005() {
	...
	String expectedDietUnitToString =
		"package a;\n" +
//{ObjectTeams: our grammar misreads this as a value param:
/* orig:
		"public class X<A, B> {\n" +
		"  A a;\n" +
  :giro */
		"public class X<A, B A> {\n" +
// SH}
		"  public X() {\n" +
		"  }\n" +
		"}\n";
...
/* orig:
		...
		"  A a;\n" +
  :giro */
		"public class X<A extends String, B A> {\n" +
// SH}
		"  public X() {\n" +
		"  }\n" +
		"}\n";
...
public void test0008() {
	...
	String expectedDietUnitToString =
		"package a;\n" +
//{ObjectTeams: here our grammar happens to come closer to reality:
/* orig:
		"public class X<A> {\n" +
		"  exteds B;\n" +
  :giro */
		"public class X<A exteds> {\n" +
// SH}
		"  A a;\n" +
		"  public X() {\n" +
		"  }\n" +
