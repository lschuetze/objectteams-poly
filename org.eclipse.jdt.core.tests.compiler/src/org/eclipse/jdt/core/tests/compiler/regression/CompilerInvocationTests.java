...
public void _test011_problem_categories() {
// SH}
	try {
		Class iProblemClass;
...
//{ObjectTeams: new problems (incomplete list):
        ...
        expectedProblemAttributes.put("CalloutMappingInUnboundRole", new ProblemAttributes(CategorizedProblem.CAT_MEMBER));
        expectedProblemAttributes.put("UnresolvedCalloutMethodSpec", new ProblemAttributes(CategorizedProblem.CAT_MEMBER));
        expectedProblemAttributes.put("AmbiguousCalloutMethodSpec", new ProblemAttributes(CategorizedProblem.CAT_MEMBER));
        ...
        expectedProblemAttributes.put("OTKeywordInRegularClass", new ProblemAttributes(CategorizedProblem.CAT_SYNTAX));
        expectedProblemAttributes.put("IllegalOTIdentifier", new ProblemAttributes(CategorizedProblem.CAT_SYNTAX));
        expectedProblemAttributes.put("PlayedByInRegularClass", new ProblemAttributes(CategorizedProblem.CAT_SYNTAX));
        expectedProblemAttributes.put("MethodMappingNotInClass", new ProblemAttributes(CategorizedProblem.CAT_SYNTAX));
        expectedProblemAttributes.put("IllegalModifierInCalloutShort", new ProblemAttributes(CategorizedProblem.CAT_SYNTAX));
        expectedProblemAttributes.put("WrongModifierInCalloutBinding", new ProblemAttributes(CategorizedProblem.CAT_SYNTAX));
        ...
        expectedProblemAttributes.put("IllegalModifierInMethodSpecRight", new ProblemAttributes(CategorizedProblem.CAT_SYNTAX));
        expectedProblemAttributes.put("SyntaxErrorIllegalDeclaredLifting", new ProblemAttributes(CategorizedProblem.CAT_SYNTAX));
        ...
        expectedProblemAttributes.put("UnresolvedLifting", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("UnsupportedRoleDataflow", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("RoleFileForBinaryTeam", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("MissingRoleInBinaryTeam", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("MissingCopiedRole", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("CorruptBytecode", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("IncompatibleJRE", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("IncompleteDependentTypesImplementation", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("ExprimentalFeature", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("StaleTSuperRole", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("StaleSubRole", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("MissingAccessorInBinary", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("RoleFileInBinaryTeam", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("MismatchingRoleParts", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("InconsistentlyResolvedRole", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("CompilationOrderProblem", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("NotGeneratingCallinBinding", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("SearchingBaseclassTooEarly", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("StaticRoleFieldMustBeFinal", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
        expectedProblemAttributes.put("IllegallyCopiedDefaultCtor", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
...
//{ObjectTeams: new constants:
        ...
        expectedProblemAttributes.put("TeamCannotHaveSuperTypes", SKIP);
        expectedProblemAttributes.put("IllegalModifierForTeam", SKIP);
        expectedProblemAttributes.put("SuperTeamNotFound", SKIP);
        expectedProblemAttributes.put("SuperTeamNotVisible", SKIP);
        expectedProblemAttributes.put("SuperTeamAmbiguous", SKIP);
        expectedProblemAttributes.put("SuperTeamInternalNameProvided", SKIP);
        expectedProblemAttributes.put("SuperTeamInheritedNameHidesEnclosingName", SKIP);
        expectedProblemAttributes.put("TEAM_RELATED", SKIP);
        ...
        expectedProblemAttributes.put("ExternalizedCallToNonPublicConstructor", SKIP);
        expectedProblemAttributes.put("IndirectTSuperInvisible", SKIP);
        expectedProblemAttributes.put("RoleCantInitializeStaticField", SKIP);
        expectedProblemAttributes.put("ExternalizingNonPublicRole", SKIP);
        expectedProblemAttributes.put("AlmostExternalizingNonPublicRole", SKIP);
        expectedProblemAttributes.put("MissingAnchorForRoleType", SKIP);
        expectedProblemAttributes.put("TypeAnchorNotEnclosingTeam", SKIP);
        expectedProblemAttributes.put("IllegalTypeAnchorNotATeam", SKIP);
        expectedProblemAttributes.put("UnresolvedTypeAnchor", SKIP);
        expectedProblemAttributes.put("NoSuchRoleInTeam", SKIP);
        expectedProblemAttributes.put("DeprecatedPathSyntax", SKIP);
        expectedProblemAttributes.put("QualifiedRole", SKIP);
        expectedProblemAttributes.put("AnchorNotFinal", SKIP);
        expectedProblemAttributes.put("AnchorPathNotFinal", SKIP);
        expectedProblemAttributes.put("AnchorNotAVariable", SKIP);
        expectedProblemAttributes.put("RoleAllocationNotRelativeToEnclosingTeam", SKIP);
        expectedProblemAttributes.put("NoTeamAnchorInScope", SKIP);
        expectedProblemAttributes.put("ExternalizedRoleNotAllowedHere", SKIP);
        expectedProblemAttributes.put("ExtendingExternalizedRole", SKIP);
        expectedProblemAttributes.put("CycleInFieldAnchor", SKIP);
        expectedProblemAttributes.put("CannotImportRole", SKIP);
        expectedProblemAttributes.put("QualifiedProtectedRole", SKIP);
        expectedProblemAttributes.put("ParameterizedProtectedRole", SKIP);
        expectedProblemAttributes.put("RoleFileMustDeclareOneType", SKIP);
        expectedProblemAttributes.put("RoleFileMismatchingName", SKIP);
        expectedProblemAttributes.put("MismatchingPackageForRole", SKIP);
        expectedProblemAttributes.put("NonTeamPackageForRole", SKIP);
        expectedProblemAttributes.put("NoEnclosingTeamForRoleFile", SKIP);
        expectedProblemAttributes.put("JavadocMissingRoleTag", SKIP);
        expectedProblemAttributes.put("JavadocRoleTagNotRoleFile", SKIP);
        expectedProblemAttributes.put("JavadocRoleTagNotRole", SKIP);
        expectedProblemAttributes.put("JavadocRoleTagInlineRole", SKIP);
        expectedProblemAttributes.put("JavadocRoleTagInRegular", SKIP);

        expectedProblemAttributes.put("RoleFileCantBeEnum", SKIP);
        expectedProblemAttributes.put("RegularExtendsTeam", SKIP);
        expectedProblemAttributes.put("SuperclassMustBeATeam", SKIP);
        expectedProblemAttributes.put("RoleClassOverridesInterface", SKIP);
        expectedProblemAttributes.put("RoleInterfaceOverridesClass", SKIP);
        expectedProblemAttributes.put("OverridingFinalRole", SKIP);
        expectedProblemAttributes.put("DifferentTeamClass", SKIP);
        expectedProblemAttributes.put("TSuperOutsideRole", SKIP);
        expectedProblemAttributes.put("TSuperCallWithoutTSuperRole", SKIP);
        expectedProblemAttributes.put("InvalidQualifiedTSuper", SKIP);
        expectedProblemAttributes.put("TSuperCallsWrongMethod", SKIP);
        expectedProblemAttributes.put("ReducingRoleVisibility", SKIP);
        expectedProblemAttributes.put("TSubMethodReducesVisibility", SKIP);
        expectedProblemAttributes.put("IncompatibleReturnInCopiedMethod", SKIP);
        expectedProblemAttributes.put("ExtendIncompatibleEnclosingTypes", SKIP);
        expectedProblemAttributes.put("IncompatibleSuperclasses", SKIP);
        expectedProblemAttributes.put("TsuperCtorDespiteRefinedExtends", SKIP);
        expectedProblemAttributes.put("CallToInheritedNonPublic", SKIP);
        expectedProblemAttributes.put("RoleShadowsVisibleType", SKIP);
        expectedProblemAttributes.put("ImplicitlyHidingField", SKIP);
        expectedProblemAttributes.put("RegularOverridesTeam", SKIP);
        expectedProblemAttributes.put("MissingTeamForRoleWithMembers", SKIP);
        expectedProblemAttributes.put("TeamExtendingEnclosing", SKIP);
        expectedProblemAttributes.put("IncomparableTSupers", SKIP);
        expectedProblemAttributes.put("MissingOverrideAnnotationForRole", SKIP);
        expectedProblemAttributes.put("RoleMustOverride", SKIP);
        expectedProblemAttributes.put("ROLE_RELATED", SKIP);
        expectedProblemAttributes.put("OverlappingRoleHierarchies", SKIP);
        expectedProblemAttributes.put("IllegalPlayedByRedefinition", SKIP);
        expectedProblemAttributes.put("IncompatibleBaseclasses", SKIP);
        expectedProblemAttributes.put("OverridingPlayedBy", SKIP);
        expectedProblemAttributes.put("BaseclassMustBeAClass", SKIP);
        expectedProblemAttributes.put("BaseclassIsMember", SKIP);
        expectedProblemAttributes.put("BaseclassIsRoleOfTheSameTeam", SKIP);
        expectedProblemAttributes.put("BaseclassIsEnclosing", SKIP);
        expectedProblemAttributes.put("BaseclassCircularity", SKIP);
        expectedProblemAttributes.put("BaseclassDecapsulation", SKIP);
        expectedProblemAttributes.put("BaseclassDecapsulationFinal", SKIP);
        expectedProblemAttributes.put("ConfinedDecapsulation", SKIP);
        expectedProblemAttributes.put("BaseImportInRegularClass", SKIP);
        expectedProblemAttributes.put("BaseImportInRoleFile", SKIP);
        expectedProblemAttributes.put("RegularlyImportedBaseclass", SKIP);
        expectedProblemAttributes.put("QualifiedReferenceToBaseclass", SKIP);
        expectedProblemAttributes.put("ParameterizedBaseclass", SKIP);
        expectedProblemAttributes.put("NonParameterizedBaseclass", SKIP);
        expectedProblemAttributes.put("DeprecatedBaseclass", new ProblemAttributes(OTDTPlugin.OT_COMPILER_ADAPTING_DEPRECATED));
        expectedProblemAttributes.put("IllegalBaseImport", SKIP);
        expectedProblemAttributes.put("IllegalBaseImportExpected", SKIP);
        expectedProblemAttributes.put("IllegalBaseImportNoAspectBinding", SKIP);
        expectedProblemAttributes.put("BaseclassDecapsulationForcedExport", SKIP);
        expectedProblemAttributes.put("AdaptedPluginAccess", SKIP);
        expectedProblemAttributes.put("IllegalUseOfForcedExport", SKIP);
        expectedProblemAttributes.put("BaseImportFromSplitPackage", SKIP);
        expectedProblemAttributes.put("BaseImportFromSplitPackagePlural", SKIP);
        expectedProblemAttributes.put("IllegalImplicitLower", SKIP);
        expectedProblemAttributes.put("OmitCastForLowering", SKIP);
        expectedProblemAttributes.put("UseTmpForLoweringInstanceof", SKIP);
        expectedProblemAttributes.put("AmbiguousUpcastOrLowering", SKIP);
        ...
        expectedProblemAttributes.put("PrimitiveTypeNotAllowedForLifting", SKIP);
        expectedProblemAttributes.put("NeedRoleInLiftingType", SKIP);
        expectedProblemAttributes.put("RoleNotBoundCantLift", SKIP);
        expectedProblemAttributes.put("IncompatibleBaseForRole", SKIP);
        expectedProblemAttributes.put("SyntaxErrorInDeclaredArrayLifting", SKIP);
        ...
        expectedProblemAttributes.put("AbstractRelevantRole", SKIP);
        expectedProblemAttributes.put("BaseQualifiesNonTeam", SKIP);
        ...
        expectedProblemAttributes.put("DifferentParamInCalloutMethodSpec", SKIP);
        expectedProblemAttributes.put("RegularCalloutOverrides", SKIP);
        expectedProblemAttributes.put("AbstractMethodBoundAsOverride", SKIP);
        expectedProblemAttributes.put("CalloutOverridesLocal", SKIP);
        expectedProblemAttributes.put("RegularCalloutOverridesCallout", SKIP);
        expectedProblemAttributes.put("DuplicateCalloutBinding", SKIP);
        ...
        expectedProblemAttributes.put("DuplicateCalloutParamMapping", SKIP);
        expectedProblemAttributes.put("UnmappedBaseParameter", SKIP);
        expectedProblemAttributes.put("WrongBindingDirection", SKIP);
        expectedProblemAttributes.put("WrongBindingDirectionResult", SKIP);
        expectedProblemAttributes.put("ResultMappingForVoidMethod", SKIP);
        expectedProblemAttributes.put("IllegalDirectionForCalloutResult", SKIP);
        expectedProblemAttributes.put("ResultNotDefinedForVoidMethodCallout", SKIP);
        expectedProblemAttributes.put("CalloutMappingResultToOther", SKIP);
        expectedProblemAttributes.put("TooFewArgumentsInCallout", SKIP);
        expectedProblemAttributes.put("CalloutMissingReturnType", SKIP);
        expectedProblemAttributes.put("ParamMapInInterface", SKIP);
        expectedProblemAttributes.put("CalloutTypeMismatch", SKIP);
        expectedProblemAttributes.put("IncompatibleMappedCalloutArgument", SKIP);
        expectedProblemAttributes.put("ReturnRequiredInCalloutMethodMapping", SKIP);
        expectedProblemAttributes.put("CalloutIncompatibleReturnType", SKIP);
        expectedProblemAttributes.put("DecapsulationShort", SKIP);
        expectedProblemAttributes.put("Decapsulation", SKIP);
        expectedProblemAttributes.put("InvisibleMethodSpec", SKIP);
        expectedProblemAttributes.put("CalloutInvisiblePrivate", SKIP);
        expectedProblemAttributes.put("UnresolvedFieldInCallout", SKIP);
        expectedProblemAttributes.put("DifferentTypeInFieldSpec", SKIP);
        expectedProblemAttributes.put("FieldAccessHasNoEffect", SKIP);
        expectedProblemAttributes.put("CalloutSetCantReturn", SKIP);
        expectedProblemAttributes.put("CalloutToFieldMissingParameter", SKIP);
        ...
        expectedProblemAttributes.put("UsingCalloutToFieldForFieldRead", SKIP);
        expectedProblemAttributes.put("UsingInferredCalloutToFieldForMessageSend", SKIP);
        expectedProblemAttributes.put("DecapsulationFieldReference", SKIP);
        expectedProblemAttributes.put("DecapsulationMessageSend", SKIP);
        expectedProblemAttributes.put("CALLIN_RELATED", SKIP);
        ...
        expectedProblemAttributes.put("DifferentParamInCallinMethodSpec", SKIP);
        expectedProblemAttributes.put("DuplicateCallinName", SKIP);
        expectedProblemAttributes.put("CallinToInheritedFinal", SKIP);
        expectedProblemAttributes.put("CallinUndeclaredException", SKIP);
        expectedProblemAttributes.put("CallinToDeprecated", new ProblemAttributes(OTDTPlugin.OT_COMPILER_ADAPTING_DEPRECATED));
        expectedProblemAttributes.put("CallinInNonRole", SKIP);
        expectedProblemAttributes.put("CallinWithVisibility", SKIP);
        expectedProblemAttributes.put("CallToCallin", SKIP);
        expectedProblemAttributes.put("CalloutBindingCallin", SKIP);
        ...
        expectedProblemAttributes.put("BaseCallDoesntMatchRoleMethodSignature", SKIP);
        expectedProblemAttributes.put("PotentiallyMissingBaseCall", new ProblemAttributes(OTDTPlugin.OT_COMPILER_BASE_CALL));
        expectedProblemAttributes.put("DefinitelyMissingBaseCall", new ProblemAttributes(OTDTPlugin.OT_COMPILER_BASE_CALL));
        expectedProblemAttributes.put("PotentiallyDuplicateBaseCall", new ProblemAttributes(OTDTPlugin.OT_COMPILER_BASE_CALL));
        expectedProblemAttributes.put("DefinitelyDuplicateBaseCall", new ProblemAttributes(OTDTPlugin.OT_COMPILER_BASE_CALL));
        expectedProblemAttributes.put("MissingBaseCallResult", SKIP);
        expectedProblemAttributes.put("FragileCallinBindingBaseType", SKIP);
        expectedProblemAttributes.put("FragileCallinBindingReferenceType", SKIP);
        expectedProblemAttributes.put("BaseSuperCallToNonOverriding", SKIP);
        expectedProblemAttributes.put("BaseSuperCallDecapsulation", SKIP);
        expectedProblemAttributes.put("CallinParameterMappingMissingSingatures", SKIP);
        expectedProblemAttributes.put("IllegalDirectionForCallinResult", SKIP);
        expectedProblemAttributes.put("TooFewArgumentsInCallin", SKIP);
        ...
        expectedProblemAttributes.put("CallinIncompatibleReturnTypeBaseCall", SKIP);
        expectedProblemAttributes.put("CallinMappingResultToOther", SKIP);
        expectedProblemAttributes.put("BaseArgInNonSimpleExpression", SKIP);
        expectedProblemAttributes.put("IllegalBindingDirectionNonReplaceCallin", SKIP);
        expectedProblemAttributes.put("CallinTypeMismatch", SKIP);
        expectedProblemAttributes.put("IncompatibleMappedCallinArgument", SKIP);
        expectedProblemAttributes.put("ReturnRequiredInCallinMethodMapping", SKIP);
        expectedProblemAttributes.put("TypesNotTwowayCompatibleInReplace", SKIP);
        expectedProblemAttributes.put("DuplicateUseOfTypeVariableInCallin", SKIP);
        expectedProblemAttributes.put("CallinDecapsulation", SKIP);
        expectedProblemAttributes.put("CallinInvisiblePrivate", SKIP);
        ...
        expectedProblemAttributes.put("ReplaceCallinIncompatibleStatic", SKIP);
        expectedProblemAttributes.put("UnknownPrecedence", SKIP);
        expectedProblemAttributes.put("IllegalDeepRoleReferenceInPrecedence", SKIP);
        ...
        expectedProblemAttributes.put("WithinStatementNeedsTeamInstance", SKIP);
        expectedProblemAttributes.put("CheckedExceptionInGuard", SKIP);
        expectedProblemAttributes.put("PredicateHasNoArguments", SKIP);
        expectedProblemAttributes.put("BasePredicateInUnboundRole", SKIP);
        expectedProblemAttributes.put("API_RELATED", SKIP);
        expectedProblemAttributes.put("RoleClassLiteralLacksTeamInstance", SKIP);
        expectedProblemAttributes.put("ExternalizedRoleClassLiteral", SKIP);
        expectedProblemAttributes.put("OverridingPredefined", SKIP);
        expectedProblemAttributes.put("ENCAPS_RELATED", SKIP);
        expectedProblemAttributes.put("OverridingConfined", SKIP);
        expectedProblemAttributes.put("ArrayOfConfinedNotConform", SKIP);
        expectedProblemAttributes.put("JP_RELATED", SKIP);
        expectedProblemAttributes.put("GenericJPError", SKIP);
        expectedProblemAttributes.put("DEPENDENT_RELATED", SKIP);
        expectedProblemAttributes.put("AnchorReferenceNotAValue", SKIP);
        expectedProblemAttributes.put("AnchorReferenceNotAnObjectRef", SKIP);
        ...
        expectedProblemAttributes.put("IllegalOTIdentifier", SKIP);
        expectedProblemAttributes.put("PlayedByInRegularClass", SKIP);
        expectedProblemAttributes.put("MethodMappingNotInClass", SKIP);
        expectedProblemAttributes.put("IllegalModifierInCalloutShort", SKIP);
        expectedProblemAttributes.put("WrongModifierInCalloutBinding", SKIP);
        ...
        expectedProblemAttributes.put("IllegalModifierInMethodSpecRight", SKIP);
        expectedProblemAttributes.put("SyntaxErrorIllegalDeclaredLifting", SKIP);
        expectedProblemAttributes.put("MissingPredicateExpression", SKIP);
        expectedProblemAttributes.put("ValueParamWrongPosition", SKIP);
        expectedProblemAttributes.put("RebindingTypeVariableAnchor", SKIP);
        expectedProblemAttributes.put("SyntaxErrorSingleTypeReferenceExpected", SKIP);
        expectedProblemAttributes.put("LIMITATIONS", SKIP);
        expectedProblemAttributes.put("UnsupportedUseOfGenerics", SKIP);
        expectedProblemAttributes.put("UnresolvedLifting", SKIP);
        expectedProblemAttributes.put("UnsupportedRoleDataflow", SKIP);
        expectedProblemAttributes.put("RoleFileForBinaryTeam", SKIP);
        expectedProblemAttributes.put("MissingRoleInBinaryTeam", SKIP);
        expectedProblemAttributes.put("MissingCopiedRole", SKIP);
        expectedProblemAttributes.put("CorruptBytecode", SKIP);
        expectedProblemAttributes.put("IncompatibleJRE", SKIP);
        expectedProblemAttributes.put("IncompleteDependentTypesImplementation", SKIP);
        expectedProblemAttributes.put("ExprimentalFeature", SKIP);
        expectedProblemAttributes.put("StaleTSuperRole", SKIP);
        expectedProblemAttributes.put("StaleSubRole", SKIP);
        expectedProblemAttributes.put("MissingAccessorInBinary", SKIP);
        expectedProblemAttributes.put("RoleFileInBinaryTeam", SKIP);
        expectedProblemAttributes.put("MismatchingRoleParts", SKIP);
        expectedProblemAttributes.put("InconsistentlyResolvedRole", SKIP);
        expectedProblemAttributes.put("CompilationOrderProblem", SKIP);
        expectedProblemAttributes.put("NotGeneratingCallinBinding", SKIP);
        expectedProblemAttributes.put("SearchingBaseclassTooEarly", SKIP);
        expectedProblemAttributes.put("StaticRoleFieldMustBeFinal", SKIP);
        expectedProblemAttributes.put("IllegallyCopiedDefaultCtor", SKIP);
        expectedProblemAttributes.put("ReadonlyNotYetSupported", SKIP);
        expectedProblemAttributes.put("MissingImplementation", SKIP);
        expectedProblemAttributes.put("TryingToWeaveIntoSystemClass", SKIP);
        ...
        expectedProblemAttributes.put("MigrateToNonTeam", SKIP);
        expectedProblemAttributes.put("MigrateToWrongTeam", SKIP);
        expectedProblemAttributes.put("MigrateBoundRole", SKIP);
