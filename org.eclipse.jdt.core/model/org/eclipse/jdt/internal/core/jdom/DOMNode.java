 ...
 * $Id: DOMNode.java 19914 2009-04-18 23:34:13Z stephan $
 *
 * Contributors:
...
protected void becomeDetailed() throws DOMException {
	if (!isDetailed()) {
		...
		if (detailed == null) {
//{ObjectTeams:
//FIXME(gbr) Generating detailed source indexes fails when renaming a team package
//		      or renaming the compilation unit of a role file (see TPX-365)!
