...
// :giro
	  ...
	  throw oce; // keep old behavior.
  } catch (Throwable t) {
	  throw new JavaModelException(t, IStatus.ERROR);
  }
// SH}
}
/**
...
//{ObjectTeams: extra carefull:
	  ...
	  throw jme; // keep old behavior.
  } catch (OperationCanceledException oce) {
	  throw oce; // keep old behavior.
  } catch (Throwable t) {
	  throw new JavaModelException(t, IStatus.ERROR); // this one can be caught by higher levels.
  }
// SH}
}
