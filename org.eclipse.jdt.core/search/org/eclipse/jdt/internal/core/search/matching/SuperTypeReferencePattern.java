 ...
 * $Id: SuperTypeReferencePattern.java 19915 2009-04-19 17:23:21Z stephan $
 *
 * Contributors:
...
//{ObjectTeams: base class references:
public static final int ONLY_BASE_CLASSES = 3; // used for PLAYEDBY_REFERENCES
// SH}
...
protected StringBuffer print(StringBuffer output) {
	switch (this.superRefKind) {
		...
		case ONLY_SUPER_CLASSES:
			...
			break;
//{ObjectTeams: base classes:
		case ONLY_BASE_CLASSES:
			output.append("BaseClassReferencePattern: <"); //$NON-NLS-1$
			break;
// SH}
	}
	if (this.superSimpleName != null)
