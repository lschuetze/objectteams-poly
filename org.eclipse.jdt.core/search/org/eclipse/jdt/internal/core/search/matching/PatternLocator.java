 ...
 * $Id: PatternLocator.java 23417 2010-02-03 20:13:55Z stephan $
 *
 * Contributors:
...
import org.eclipse.objectteams.otdt.internal.core.search.matching.RoleDeclarationLocator;
...
//{ObjectTeams: support for OT elements
		case IIndexConstants.TEAM_DECL_PATTERN :
...
//{ObjectTeams:
//TODO (carp): at some point, we will need a subclass MethodMappingLocator!
public int match(CalloutMappingDeclaration calloutMappingDeclaration, MatchingNodeSet nodeSet)
{
    // each subtype should override if needed
    return IMPOSSIBLE_MATCH;
}
public int match(CallinMappingDeclaration callinMappingDeclaration, MatchingNodeSet nodeSet)
{
    // each subtype should override if needed
    return IMPOSSIBLE_MATCH;
}
...
public int match(FieldAccessSpec fieldSpec, MatchingNodeSet nodeSet)
{
    // each subtype should override if needed
    return IMPOSSIBLE_MATCH;
}
...
//{ObjectTeams: playedBy reference:
