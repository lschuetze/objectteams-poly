...
//{ObjectTeams: check fineGrain: instantiation via lifting only acceptable when reported directly against the type reference
	if ((accuracy & SearchMatch.A_CHECKED) == 0) {
		if ((this.fineGrain & IJavaSearchConstants.CLASS_INSTANCE_CREATION_TYPE_REFERENCE) != 0) {
