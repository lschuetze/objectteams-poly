 ...
 * $Id: CodeFormatter.java 22627 2009-09-30 23:28:30Z stephan $
 *
 * Contributors:
...
//{ObjectTeams: a separate kind is necessary because of separate parsing method (parser.parseParameterMapping)
	 ...
	 * To format a parameter mapping snippet it is not possible to use the method
	 * parse.parseExpression ( K_EXPRESSION ) even though the ASTNode ParameterMapping inherits from Expression.
	 * So it is necessary to use the new snippet kind K_PARAMETER_MAPPING and therefore
