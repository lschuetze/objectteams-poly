...
//  ==== CALLIN ====
	...
	int NonReplaceExpressionInReplaceResult      = CALLIN_RELATED + 4006; // 4.4(b)
	int CallinIllegalRoleReturn 				 = CALLIN_RELATED + 4007; // 4.4(b)
	int CallinIncompatibleReturnType			 = CALLIN_RELATED + 4008; // 4.4(b)
	int CallinIncompatibleReturnTypeBaseCall	 = CALLIN_RELATED + 4009; // 4.4(b)
	int CallinMappingResultToOther 				 = CALLIN_RELATED + 4010; // 4.4(b)
	int BaseArgInNonSimpleExpression 			 = CALLIN_RELATED + 4011; // 4.4(b)
	int IllegalBindingDirectionNonReplaceCallin  = CALLIN_RELATED + 4012; // 4.4(c)
