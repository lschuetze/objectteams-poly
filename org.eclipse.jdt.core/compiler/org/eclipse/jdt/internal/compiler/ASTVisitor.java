 ...
 * $Id: ASTVisitor.java 23404 2010-02-03 14:10:22Z stephan $
 *
 * Contributors:
 ...
 *    LiftingTypeReference, WithinStatement, TsuperReference, BaseReference, BaseCallMessageSend,
 *    MethodSpec, CallinMappingDeclaration, CalloutMappingDeclaration, ParameterMapping,
 *
 */
...
//{ObjectTeams:  visit new ast nodes:
	...
	public void endVisit(BaseReference basetsuperReference, BlockScope scope) {
		// do nothing by default
	}
	public void endVisit(MethodSpec methodSpec, BlockScope scope) {
		// do nothing by default
	}
	public void endVisit(CallinMappingDeclaration callinBindingDeclaration, ClassScope scope) {
		// do nothing by default
	}
	public void endVisit(CalloutMappingDeclaration calloutBindingDeclaration, ClassScope scope) {
		// do nothing by default
	}
...
//{ObjectTeams: visit new ast nodes:
	...
	public boolean visit(TsuperReference tsuperReference, BlockScope scope) {
		return true; // do nothing by default, keep traversing
 	}

	public boolean visit(BaseReference baseReference, BlockScope scope) {
		return true; // do nothing by default, keep traversing
	}
