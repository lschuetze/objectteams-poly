 ...
 * $Id: SyntheticArgumentBinding.java 19874 2009-04-13 17:59:05Z stephan $
 *
 * Contributors:
...
//{ObjectTeams: for type value parameters:
	public SyntheticArgumentBinding(char[] name, ReferenceBinding parameterType) {
		super(name, parameterType, ClassFileConstants.AccFinal, true);
	}
// SH}
}
