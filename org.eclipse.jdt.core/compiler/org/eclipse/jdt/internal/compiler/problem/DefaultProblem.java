...
//{ObjectTeams: capability for rechecking:
	public IProblemRechecker rechecker;
	public boolean shouldBeReported(IrritantSet[] foundIrritants) {
		if (this.rechecker != null)
			return this.rechecker.shouldBeReported(foundIrritants);
		return true;
	}
// SH}
...
//{ObjectTeams: treatment for problems in generated code:
/**
 * mark this problem as referring to a generated element that should be ignored.
 */
public void markGenerated() {
	this.severity |= ProblemSeverities.IgnoredGenerated;
}
/**
 * Is this problem referring to a generated element, which is to be ignored?
 */
public boolean isInGenerated() {
	return (this.severity & ProblemSeverities.IgnoredGenerated) != 0;
}
// SH}
}
