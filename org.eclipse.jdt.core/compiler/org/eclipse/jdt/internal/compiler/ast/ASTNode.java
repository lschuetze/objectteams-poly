 ...
 * OTDT changes:
 *
 * What: pretty printing of OT-specific modifiers.
 *
 * What: resolve annotations of method bindings.
 *
 * @version $Id: ASTNode.java 23405 2010-02-03 17:02:18Z stephan $
 */
...
//{ObjectTeams:
//	+ Argument uses HasBeenResolved to singal that bind() has worked
//	  and has stored the LocalVariableBinding in the method scope.
//  + MessageSend uses HasBeenResolved to signal that argument enhancing has occurred.
	public static final int HasBeenTransformed = Bit3; // by TransformStatementsVisitor
...
/* orig:
  ...
  :giro */
						restriction.classpathEntryType, restriction);
// SH}
...
//{ObjectTeams: don't consider certain generated usages:
		  if (!((scope instanceof MethodScope) && scope.isGeneratedScope() && !scope.isMethodMappingWrapper()))
// SH}
