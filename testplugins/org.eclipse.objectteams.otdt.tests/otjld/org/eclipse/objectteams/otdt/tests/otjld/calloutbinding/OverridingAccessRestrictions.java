...
//		TESTS_RANGE = new int[] { 1097, -1 };
    ...
    // protected methods, no need for indirect dispatch
    public void testBug468116a() throws Exception {
    	runConformTest(
    		new String[] {
				"pt/MyTeam.java",
				"package pt;\n" +
    ...
    // package private methods, need indirect dispatch
    public void testBug468116b() throws Exception {
    	runConformTest(
    		new String[] {
				"pt/MyTeam.java",
				"package pt;\n" +
