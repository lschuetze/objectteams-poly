 ...
 * 
 */
public class OTTypeHierarchyBuilderTest2 extends FileBasedModelTest 
{
	...
	public OTTypeHierarchyBuilderTest2(String name)
	{
		super(name);
	}
	...
	public static Test suite()
	{
		if (true)
		{
			return new Suite(OTTypeHierarchyBuilderTest2.class);
		}
		@SuppressWarnings("unused")
		junit.framework.TestSuite suite = 
			new Suite(OTTypeHierarchyBuilderTest2.class.getName());
		return suite;
	}
